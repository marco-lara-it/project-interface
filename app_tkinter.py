...
class MyApp(tk.Frame):
    def __init__(self, master=None):
        ...
        self.master.resizable(False, False) #modificare dimensioni finestra
        self.initUI()
    ...
    def salva_dati(self):
        ...
        if nome and cognome and eta:
            ...
            #svuotare caselle alla fine
            self.input1.delete(0, tk.END)
            self.input2.delete(0, tk.END)
            self.input3.delete(0, tk.END)
            self.input1.focus_set() #focus
            self.input1.icursor(tk.END) #cursore
        else:
            # messaggio di errore
